...
void TestRequestParse() {
  ...
  std::cout << "Method: " << HttpUtils::Method2String(request.p_Method)
            << std::endl;
  std::cout << "Path: " << request.p_Path << std::endl;
  std::cout << "Version: " << HttpUtils::Version2String(request.p_Version)
            << std::endl;

  std::cout << "\n[Headers]\n";
  for (auto &[k, v] : request.p_Headers) {
    std::cout << k << ": " << v << std::endl;
  }

  std::cout << "\n[Body]\n";
  std::cout << request.p_Body << std::endl;
}
